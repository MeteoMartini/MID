...
- Tmin bleibt ausschließlich in der blauen Farbfamilie. Die Sättigung folgt der signierten Abweichung vom klimatologischen Tmin: deutlich kälter = sehr kräftig/dunkel, Klimamittel = helleres Referenzblau, deutlich milder = sehr helle/entsättigte Blautönung.
- Tmax bleibt ausschließlich in der roten Farbfamilie. Die Sättigung folgt der signierten Abweichung vom klimatologischen Tmax: deutlich kühler = sehr hell/entsättigt, Klimamittel = kräftiges Basisrot, deutlich wärmer = sehr kräftig/dunkel.
