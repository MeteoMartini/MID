...
- Die fünf gleichrangigen Hauptziele lauten **Aktuell · Heute · Vorhersage · Karten · Mehr**. Die Beschriftungen bleiben einzeilig; MID trennt sie nicht mitten im Wort. **Heute** öffnet die kanonische Kurzfristansicht; **Vorhersage** führt zur zuletzt passenden 7-/14-Tage- oder Langfristansicht. Amtliche Warnungen und MID-Hinweise bleiben als stets antippbarer **Warnlage**-Status im Ortskopf sichtbar; diese Statusfläche führt direkt in die Warnübersicht. Eine Quellenstörung wird dort ausdrücklich als solche dargestellt und niemals als Entwarnung behandelt.
- **Aktuell** öffnet wieder unmittelbar **Aktuelles Wetter** in der kanonischen vollständigen Current-Ansicht. **Warnungen** führt unmittelbar zur amtlichen Warnlage samt MID-Hinweisen und bietet dort den direkten Einstieg in den Extremwetter-Ausblick. **Mehr** enthält die vertiefenden Fachmodule und Einstiege, insbesondere 14 Tage, Event/Reise, Berg/Winter, Wasser, Langfrist-, Analyse- und Profiwerkzeuge. Häufige Funktionen der früheren Top-Bar liegen oben als Schnellzugriffe: Einstellungen, Benachrichtigungen, Favoriten & Profile, Wetterzwilling und Updates. **Karten** öffnet direkt den Komposit-/Kartenfokus.
...
- Unter **Einstellungen → Ansicht** kann die Bottom-Bar auf **Auto** oder **Fixiert** gestellt werden. Fixiert hält alle fünf Ziele dauerhaft vollständig sichtbar. Im Auto-Modus minimiert sie sich beim deutlichen **Abwärtsscrollen** erst nach einer größeren zusammenhängenden Scrollstrecke. Sie verschwindet dabei nicht vollständig, sondern lässt einen sichtbaren Glass-Griff am unteren Rand stehen. Ein kurzer Aufwärtsscroll, Tap auf den Griff, Nähe zum Seitenanfang, Fokus innerhalb der Leiste oder das Öffnen von **Mehr** stellt sie vollständig wieder her. Kleine Scrollzitterbewegungen dürfen die Leiste nicht permanent umschalten.
