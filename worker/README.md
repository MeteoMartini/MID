# MID Daten-, Warnungs- und Radarproxy v0.7.61

In v0.7.61 erfolgte ausschließlich die einheitliche Versionsanhebung; die Worker-Funktionalität bleibt gegenüber v0.7.60 unverändert.
