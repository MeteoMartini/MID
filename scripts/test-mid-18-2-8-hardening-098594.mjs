...
const checks=[
 ...
 ['Rapid thunder exposes signal score',fusion.includes('return{level,signalScore,support:')],
 ['Detail thunder names score semantics',detail.includes('never an event probability')],
 ...
 ['Short-term thunder UI no pseudo-probability',short.includes('Signal {Math.round(Number(point.thunderSignalScore))}/100')],
