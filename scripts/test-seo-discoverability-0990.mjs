...
need('Meta-Beschreibung',html,'<meta name="description" content="MID ist ein responsives Wetterdashboard');
if(/<meta name="description"[^>]*(?:kostenlos|kostenfrei)/i.test(html))failures.push('Meta-Beschreibung darf keine Kosten-/Entwicklungsinterna enthalten.');
