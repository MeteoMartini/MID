...
for(const token of ['EnsembleLegacyWeatherBand','ensemble-legacy-hazard-badges','ensemble-legacy-weather-band','DWD_WARNING_COLORS'])if(!ensemble.includes(token)&&!styles.includes(token))failures.push(`Kompakte Ensemble-Warnmarker fehlen: ${token}`);
