...
for(const token of ['<b>Hazards</b>','ensemble-hazard-tooltip','row.hazards.map'])if(!ensemble.includes(token))failures.push(`Ensemble-Warnhinweise fehlen im Tooltip: ${token}`);
