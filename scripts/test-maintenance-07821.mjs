...
for(const token of ['EnsembleHazardShape','EnsembleWeatherLayer','ZIndexLayer','ensemble-hazard-marker'])if(!ensemble.includes(token)&&!styles.includes(token))failures.push(`Kompakte Ensemble-Warnmarker fehlen: ${token}`);
