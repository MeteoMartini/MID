...
assert.ok(syncRegression.includes('v4.37.6')&&syncRegression.includes('v4.37.7'));
...
console.log(`MID v${pkg.version}: Release-Installer schützt .github, während der explizite Workflow-Sync CodeQL 4.37.7 und die Action-Pins administrativ aktualisiert.`);
