...
for(const token of [
  ...
  "const darkCloud=['thunder','thunder-solid','thunder-graupel','thunder-hail','squall','funnel-cloud'].includes(kind)",
  'cloudFillGradient=day?cloudGradient:nightCloudGradient',
  'stormFillGradient=day?stormGradient:nightStormGradient',
