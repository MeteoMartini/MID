...
if(!app.includes('recordForecastCapture(favoriteKey(loc),days,ens)')&&!app.includes('recordForecastCapture(favoriteKey(loc),days,ens,loc)'))failures.push('Prognosearchiv: recordForecastCapture für den aktiven Favoriten fehlt');
