...
assert.match(app,/<div className="actions compact-actions">[\s\S]{0,340}<PwaInstallButton suppressHint=\{suppressInstallHint\}\/>[\s\S]{0,260}<button className="settings-button"/,'App-Status muss weiterhin links neben dem Einstellungsbutton stehen; der Sektionen-Button darf davor liegen.');
