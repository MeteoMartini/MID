...
const failures=[];
const safe='<RadarNowcastTimeline radar={radarAnalysis} timezone={w?.timezone}/>';
...
console.log('Radar-Nowcast-Nullbarkeit geprüft: Zeitzone wird während des initialen Ladens nullsicher übergeben.');
