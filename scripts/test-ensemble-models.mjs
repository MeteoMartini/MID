...
const meanIds=['dwd_icon_eps_ensemble_mean_seamless','ecmwf_ifs_europe_ensemble_mean','ecmwf_aifs_europe_ensemble_mean','ncep_gefs_ensemble_mean_seamless','ecmwf_ifs025_ensemble_mean','ecmwf_aifs025_ensemble_mean','cmc_gem_geps_ensemble_mean','google_weathernext2_ensemble_mean'];
