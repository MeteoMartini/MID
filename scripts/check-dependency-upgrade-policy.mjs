...
console.log('Dependency-Policy geprüft: React 18.3.1, Recharts 3.10.1, Lucide React 1.34.0, MapLibre GL JS 6.6.0, TypeScript 7.0.2 und Vite 6.4.3 sind reproduzierbar geschützt; React 19, Vite 8 und plugin-react 6 bleiben getrennte Vollmigrationen.');
