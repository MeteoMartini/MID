...
for(const[name,version]of Object.entries(expected)){
 ...
 const expectedLocked=name==='lucide-react'?'1.34.0':version;
...
console.log('Dependency-Policy geprüft: React 18.3.1, Recharts 3.10.1, Lucide React 1.34.0, MapLibre GL JS 6.5.0, TypeScript 5.9.3 und Vite 6.4.3 sind reproduzierbar geschützt; React-19/TS-7/Vite-8 bleiben getrennte Vollmigrationen.');
