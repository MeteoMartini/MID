...
need(engine,'settings.nowcastAssimilation&&radar','Radarbeobachtungen werden nicht über den Wetterzwilling-Schalter in den Lernkreis aufgenommen.');
need(app,'finalizeForecastHours(twinHours,baseDisplayDays','Wetterzwilling verwendet nicht die gemeinsame zentrale Radar-/Modell-Endstufe.');
