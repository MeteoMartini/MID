...
const [fetcher,builder,worker,weather]=await Promise.all([
...
assert.ok(weather.includes('Zustandskern 1 h bis +14 h')&&weather.includes('Niederschlag 5 min bis +6 h')&&weather.includes('Konvektion/Reflektivität 15 min bis +6 h'),'UI muss den parameterabhängigen RUC-Zeitvertrag korrekt benennen.');
