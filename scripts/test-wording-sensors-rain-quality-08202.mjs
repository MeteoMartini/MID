...
need(engine,'export const PRIVATE_SENSOR_INTEGRATION_ENABLED=false;','Private Sensorintegration ist nicht vorläufig deaktiviert.');
...
need(stationSettings,'Datenübernahme vorübergehend deaktiviert','Netatmo-/Stationsübernahme ist in den Einstellungen nicht deaktiviert.');
need(stationSettings,'Keine Datenübertragung','Hinweis zur ausgesetzten Stationsübertragung fehlt.');
need(stationClient,'validateConnectedStation','Plausibilitätsprüfung für verbundene Stationen fehlt.');
need(stationClient,'CONNECTED_STATION_INTEGRATION_ENABLED=false','Vernetzte Stationen besitzen keine harte Deaktivierung.');
...
console.log('Modellfamilien-Wording, vorläufig deaktivierte Netatmo-/JSON-Übernahme und eindeutige Güte der Regenwahrscheinlichkeit sind geprüft.');
