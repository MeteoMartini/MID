...
for(const token of ['function EnsembleTemperatureWeatherOverlay','cellX=centerX-dayWidth*.46','cellWidth=dayWidth*.92','cellY=plotBottom-cellHeight','hazardY=plotBottom-plotHeight*.11','<EnsemblePrecipShape','<EnsembleHazardShape','row.precipVisualLabel','% Best Match'])need('Wetterband/Tooltip',panel,token);
