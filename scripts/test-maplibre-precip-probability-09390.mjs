...
need('Radar-Modell-Phase',phase,"function phaseMinimumDbz(phase:SymbolPhase){return phase==='hail'?15:phase==='graupel'?9:phase==='snow-grains'?4:(phase==='snow'||phase==='freezing'?5:7)}");
