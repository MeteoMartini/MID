...
console.log('DWD Wolken + Niederschlagsart: unverändertes amtliches Kombinationsbild mit bildgebundenen Radar-/Sat-Zeitständen erfolgreich geprüft.');
