...
for(const token of [
 "import {precipitationParts} from './precipitation'","function plausiblePrecipitation","parts.type!=='none'","data-cockpit-horizontal-scroll=\"true\"","activeHorizon==='seven-day'","cockpit-seven-grid"
