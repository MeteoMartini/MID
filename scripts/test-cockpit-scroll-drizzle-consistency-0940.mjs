...
for(const token of [
 "import {precipitationParts} from './precipitation'","function plausiblePrecipitation","buildShortTermForecast(minutes15,hours,timezone,Date.now(),anchor,radarNowcast)","data-cockpit-horizontal-scroll=\"true\"","activeHorizon==='seven-day'","cockpit-seven-grid"
