...
for(const token of [
 "import {precipitationParts} from './precipitation'","function plausiblePrecipitation","parts.type!=='none'","data-cockpit-horizontal-scroll=\"true\"","active==='seven-day'","Math.abs(dx)<=Math.abs(dy)*1.45",".cockpit-seven-grid"
