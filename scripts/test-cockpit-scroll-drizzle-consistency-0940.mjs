...
for(const token of [
 "from './precipitation'","precipitationParts","function plausiblePrecipitation","buildShortTermForecast(minutes15,hours,timezone,profileNow,anchor,radarNowcast)","data-cockpit-horizontal-scroll=\"true\"","activeHorizon==='seven-day'","cockpit-seven-grid"
