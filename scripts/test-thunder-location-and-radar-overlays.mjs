...
need('Optionale Verlagerung',radar,['showMotionOverlay:boolean','showMotionOverlay:true','showMotion=showMotionOverlay&&motionAvailable','label="Zugbahn"','motionButtonDetail=motionAvailable?']);
