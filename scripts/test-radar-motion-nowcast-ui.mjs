...
requireTokens('Kompositbild',radar,['function PrecipitationMotionArrows({anchors','motionAnchors=Array.isArray(analysis?.motionAnchors)','showMotionField=showMotion&&displayMotionAnchors.length>0','<PrecipitationMotionArrows anchors={displayMotionAnchors}','className="radar-site-motion-label"','Zug nach {Math.round(motionDirection)}°']);
