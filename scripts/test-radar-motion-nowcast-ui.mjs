...
requireTokens('Kompositbild',radar,['function PrecipitationMotionArrows({anchors','motionAnchors=Array.isArray(analysis?.motionAnchors)','showMotionField=showMotion&&displayMotionAnchors.length>0','<MemoPrecipitationMotionArrows anchors={displayMotionAnchors}','function motionArrowIcon(','mid-motion-arrow-marker','Zugrichtung nach {Math.round(motionDirection)}°']);
...
requireTokens('Nowcast-Zeitachse',app,['function RadarNowcastTimeline(','radar-nowcast-track','radar-nowcast-now','radar-nowcast-wet','Σ +2 h {radarAmountLabel(forecastAmount)} mm']);
requireTokens('Darstellung',styles,['.settings-toggle-card{','.radar-nowcast-strip{','.radar-nowcast-track{','.radar-nowcast-now{','.radar-nowcast-wet{','.mid-motion-arrow-marker{','.composite-map-interaction{']);
