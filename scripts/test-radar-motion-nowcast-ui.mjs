...
requireTokens('OPERA-Bewegungsfeld',opera,['sampleOperaMotionField','function operaMotion(','motionAnchors:latestField.anchors','nowcastSeries']);
requireTokens('Kompositbild',radar,['function PrecipitationMotionArrows({anchors','motionAnchors=Array.isArray(analysis?.motionAnchors)','showMotionField=showMotion&&motionAnchors.length>0','<PrecipitationMotionArrows anchors={motionAnchors}','className="radar-site-motion-label"','Zug {Math.round(motionDirection)}°']);
