...
requireTokens('Kompositbild',radar,['function PrecipitationMotionTrack({site','function motionTrackPoints(','const upstreamBearing=(direction+180)%360','showMotionField=showMotion','<MemoPrecipitationMotionTrack site={[lat,lon]}','function motionTrackArrowheadIcon(','mid-motion-track-arrowhead','<Marker position={arrowPoint} icon={motionTrackArrowheadIcon','Zugbahn {Math.round(motionDirection)}°']);
