...
requireTokens('Kompositbild',radar,['function PrecipitationMotionTrack({site','function motionTrackPoints(','const upstreamBearing=(direction+180)%360','showMotionField=showMotion','<MemoPrecipitationMotionTrack site={[lat,lon]}','function motionTrackArrowheadIcon(','mid-motion-track-arrowhead','<Marker position={site} icon={motionTrackArrowheadIcon','Zugrichtung nach {Math.round(motionDirection)}°']);
