...
assert.ok(weather.includes('Niederschlag 5 min bis +6 h')&&weather.includes('Konvektion/Reflektivität 15 min bis +6 h'),'Model text must expose parameter-native cadence.');
