...
for(const token of ['const weatherStripVisuals=','const baseSkyVisual=','const precipitationOverlayVisual=','const precipitationKind=','const precipBandWidth=','const precipBaseColor=','const sampleIntervalSeconds=','const sunVisualShare=','xPositions?:number[]','export function detailSkyBarSegments(','#ffc229','#aeb3b9','var(--param-precipitation)','return [...baseSegments,...precipSegments]'])if(!skybar.includes(token))failures.push(`Gemeinsamer farbreiner Wetterstreifen fehlt: ${token}`);
