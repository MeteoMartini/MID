...
for(const token of ['const weatherStripVisual=','const precipitationKind=','const precipBandWidth=','const precipSunOverlay=','underlayColor','underlayStrokeWidth','xPositions?:number[]','export function detailSkyBarSegments(','#ffc229','#aeb3b9','var(--param-precipitation)'])if(!skybar.includes(token))failures.push(`Gemeinsamer Sonne-/Bewölkungsbalken fehlt: ${token}`);
