...
console.log('Detailpiktogramme geprüft: Die Zahl richtet sich nach der Diagrammbreite; jedes Symbol repräsentiert sein Zeitfenster und kann kurze Niederschlagsereignisse priorisieren.');
