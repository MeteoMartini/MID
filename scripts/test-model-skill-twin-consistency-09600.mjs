...
assert.ok(weather.includes("const ENSEMBLE_CACHE_PREFIX='mid:ensemble:v17:'")&&weather.includes("const EVENT_ENSEMBLE_CACHE_PREFIX='mid:event-ensemble:v4:'"),'Ensemble-Caches wurden nach Gewichtsänderung nicht invalidiert.');
...
assert.ok(fusion.includes("const CACHE_PREFIX='mid:forecast-fusion:v10:'"),'Forecast-Fusion-Cache wurde nicht invalidiert.');
