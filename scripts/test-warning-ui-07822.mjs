...
for(const token of ['EnsembleHazardBadges','EnsembleWeatherStrip','ensemble-day-hazards','DWD_WARNING_COLORS'])if(!(ensemble+styles).includes(token))failures.push(`Ensemble-Warnmarker fehlt: ${token}`);
