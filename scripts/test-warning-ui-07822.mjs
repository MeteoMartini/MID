...
for(const token of ['EnsembleHazardShape','EnsembleWeatherLayer',"hazardPoint=useCartesianScale({x:row.x,y:15},0,'sky')",'ensemble-hazard-marker','DWD_WARNING_COLORS'])if(!(ensemble+styles).includes(token))failures.push(`Ensemble-Warnmarker fehlt: ${token}`);
