...
assert.ok(css.includes('.cockpit-weather-profile .cockpit-meteogram-pro__svg .night-band{opacity:.24;pointer-events:none}'),'Nachtstunden sind noch zu dominant markiert.');
