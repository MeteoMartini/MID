...
for(const token of ['Hohe Prognosekonfidenz','Erwartete Entwicklung','Konfidenz nimmt ab','Datenqualität und unvollständige Randtage werden separat ausgewiesen'])assert.ok(shared.includes(token));
