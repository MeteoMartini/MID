...
need('RUC-native-Rapidprodukte',weather,'native RUC-Niederschläge in 5-Minuten-Schritten bis +6 h und 15-Minuten-Diagnostik aus Niederschlag, ML-CAPE/CIN, DBZ_CMAX');
need('RUC-keine-künstliche-Interpolation',weather,'fehlende Temperatur-, Wind-, Druck- oder Wolkenzwischenwerte werden nicht als native Viertelstundenwerte ausgegeben.');
