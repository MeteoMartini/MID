...
for(const [label,source] of [['Flugbriefing',flightBriefing],['Wartungsverträge',maintenanceContracts]]){
 ...
 if(!source.includes("createRequire(import.meta.url)('typescript')")||!source.includes('transpileModule'))failures.push(`${label}: projektlokale TypeScript-Transpilierung für Node.js 22.16.0 fehlt.`);
}
