...
console.log('CI-Regressionen sind umgebungsunabhängig: keine Offline-npm-Probe, keine Abhängigkeit von Workflow-Kommentaren und klare Lockfile-Strukturprüfung.');
