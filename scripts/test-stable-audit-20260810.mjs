...
need('Seasonal-UI',longRange,'Saisonvorhersagen ausdrücklich aktualisieren');
need('Seasonal-UI',longRange,'seasonal-forecast-subsection');
need('Seasonal-UI',longRange,'SAISONVORHERSAGEN');
...
for(const token of ["react:'19.2.8'","recharts:'3.10.1'","typescript:'7.0.2'","vite:'8.2.2'","'@vitejs/plugin-react':'6.1.1'"])need('Dependency-Policy',policy,token);
need('Dependency-Dokumentation',policyDoc,'Recharts');
need('Dependency-Dokumentation',policyDoc,'React / React DOM / react-is: 19.2.8');
