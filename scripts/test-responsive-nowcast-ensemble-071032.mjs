...
for(const token of ['function useCompactEnsembleChart()','leftAxisWidth=compact?47:68','rightAxisWidth=compact?40:58','width={compactChart?47:68}','width={compactChart?40:58}','width={compact?40:58}'])if(!ensemble.includes(token))failures.push(`Responsive Ensemble-Logik fehlt: ${token}`);
