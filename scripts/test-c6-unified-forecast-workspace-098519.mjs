...
assert.ok(app.includes("const forecastCockpitEnabled=designMode==='mid-next';"),'Design 2.0.1 muss den gemeinsamen Prognose-Arbeitsraum unabhängig von der gespeicherten klassischen Prognoseansicht aktivieren.');
...
console.log('MID-C6 Schritt 4: gemeinsamer Prognose-Arbeitsraum für Kurzfrist, 7 und 14 Tage ausschließlich in Design 2.0.1 geprüft.');
