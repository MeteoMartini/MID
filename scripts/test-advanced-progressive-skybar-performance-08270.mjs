...
for(const token of ['function sunSample(','function cloudSample(','function precipitationSample(','export function detailSkyBarSegments(','DetailSkyBarPoint'])need('Gemeinsame Skybar-Logik',skybar,token);
