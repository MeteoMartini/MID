...
for(const active of ['function motionTrackPoints','function PrecipitationMotionTrack','const upstreamBearing=(direction+180)%360','<MemoPrecipitationMotionTrack','<Marker position={arrowPoint} icon={motionTrackArrowheadIcon']) assert.ok(radar.includes(active),`Aktiver Einzelzugspur-Vertrag fehlt: ${active}`);
...
console.log('Radar-TypeScript-Buildfix geprüft: keine toten Altvariablen, genau eine aktive Zugspur bleibt geschützt.');
