...
for(const token of ['DWD_SOURCE_RASTER_GRID:GridPoint[]','rasterPolynomialForward','rasterPolynomialInverse','Wolken + Niederschlagsart','<b>Radar</b>','<b>Sat</b>','viewport.width>=420?.44:.40'])need('Radar',radar,token);
...
console.log('Radar-/Karten-Folgefixes (Benennung, Raster-Georeferenzierung, Desktop-Meteogramm und SIGWX-Angebot) erfolgreich geprüft.');
