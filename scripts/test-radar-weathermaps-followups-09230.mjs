...
for(const token of ['DWD_RASTER_LONGITUDE_CURVES','DWD_RASTER_LATITUDE_CURVES','rasterCurveCoordinate','Wolken + Niederschlagsart','<b>Radar</b>','<b>Sat</b>','viewport.width>=420?.44:.40'])need('Radar',radar,token);
