...
need('panel',"activeSource==='opera'&&operaDisplayFrame",'OPERA wird nicht ausschließlich dann sichtbar gerendert, wenn es selbst die aktive Radarquelle ist.');
need('panel','OPERA CIRRUS dient als europäische Kontroll- und Phasenquelle','OPERA ist bei DWD-Radar nicht als reine Kontroll-/Phasenquelle dokumentiert.');
need('panel',"label:'OPERA-Bereitschaft'",'Infodialog zeigt den geprüften OPERA-Bereitschaftsstatus nicht.');
need('overlay','zIndex={355}','OPERA-Canvas besitzt keine kontrollierte Kartenebene.');
...
need('overlay','map.unproject','OPERA-Overlay wird nicht projektionstreu aus MapLibre-Viewportkoordinaten abgetastet.');
