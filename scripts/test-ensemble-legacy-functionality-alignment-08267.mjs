...
for(const token of ['trigger={chartTooltipTrigger()}','content={<TrendTooltip','content={<RainTooltip','content={<WindTooltip','function EnsembleTemperatureWeatherOverlay','<EnsemblePrecipShape','<EnsembleHazardShape','precipVisualType','SunshineScaleLegend'])need('Vollständige Ensemble-Funktion',panel,token);
