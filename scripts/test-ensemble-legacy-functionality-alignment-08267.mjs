...
for(const token of ['trigger="click"','content={<TrendTooltip','content={<RainTooltip','content={<WindTooltip','function EnsembleTemperatureWeatherOverlay','<EnsemblePrecipShape','<EnsembleHazardShape','precipVisualType','SunshineScaleLegend'])need('Vollständige Ensemble-Funktion',panel,token);
