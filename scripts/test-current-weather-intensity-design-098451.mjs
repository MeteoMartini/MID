...
for(const token of ['current-weather-facts','Niederschlag</small>','Wind / Böen</small>','Taupunkt / Feuchte</small>','Sicht</small>','Luftdruck</small>'])assert.ok(app.includes(token),`Aktuelles-Wetter-Konzept fehlt: ${token}`);
