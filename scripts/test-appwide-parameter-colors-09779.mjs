...
const checks=[
  ...
  ['cockpit precipitation uses shared phase palette with central phase tokens',cockpit.includes("import {precipitationPhaseColor} from './precipitationPhaseColor';")&&cockpit.includes('return precipitationPhaseColor(plausiblePrecipitation(sample).type)')&&precipitationPhaseColor.includes("liquid:'var(--param-precipitation)'")&&precipitationPhaseColor.includes("snow:'var(--param-precipitation-snow)'")&&precipitationPhaseColor.includes("mixed:'var(--param-precipitation-mixed)'")&&precipitationPhaseColor.includes("storm:'var(--param-precipitation-storm)'")],
