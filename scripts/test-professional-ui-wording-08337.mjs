...
for(const required of ['Prognoseentwicklung','Erwartete Entwicklung','Bewertung verschlechtert sich','Kein begrenzender Bereich erkannt'])assert.ok(ensemble.includes(required),`professionelle Kompass-Formulierung fehlt: ${required}`);
