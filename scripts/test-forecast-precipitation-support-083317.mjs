...
try{
 ...
 const supportedShower=reconcileForecastPrecipitation({precipitation:.4,rain:.05,showers:.35,probability:35,code:61,cloud:55,lowCloud:15,cape:350,sunshineDuration:1800,isDay:true,leadHours:96});assert.equal(supportedShower.precipitation,.4);assert.ok([80,81,82].includes(supportedShower.code),'bei sonnigen Auflockerungen und Konvektion wird stratiformer Regen zu Schauer korrigiert');assert.ok(supportedShower.showers>0&&supportedShower.rain===0);
