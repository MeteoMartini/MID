...
const [main,styles,cockpit,publicChangelog,packageJson]=await Promise.all([
...
console.log(`MID-C12: Vorhersage als zusammenhängender 7-/14-Tage-Arbeitsraum mit responsiver Detailtiefe und aktuellem In-App-Changelog für v${releaseVersion} geprüft.`);
