...
need(water,'data-mid-view="water"','Die Wassersport-Innenansicht muss eindeutig markiert sein.');
need(app,'id="water" title="Wassersport"','Der äußere, nicht doppelte Modultitel muss „Wassersport“ lauten.');
