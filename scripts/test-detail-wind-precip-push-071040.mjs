...
for(const token of [
 "label:'Wind / Böen'",
 "detail:`${Math.round(windDirection)}° · ${cardinalDirection(windDirection)}`",
...
console.log('Detailfelder, kompakte Windkarte mit Quelle hinter (i), Stratus-Plausibilisierung und ortsbezogene Push-Texte geprüft.');
