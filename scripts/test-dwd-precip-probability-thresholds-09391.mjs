...
need('DWD-Schwelle',weather,'precipitationProbability:weightedProbability(probabilityValues,DWD_PRECIPITATION_PROBABILITY_THRESHOLD_MM,true)');
need('DWD-Schwelle',weather,'precipitationProbabilitySignificant:weightedProbability(probabilityValues,DWD_SIGNIFICANT_PRECIPITATION_PROBABILITY_THRESHOLD_MM,true)');
...
need('Tagesdaten',weather,"probabilitySource?:'ensemble-members-dwd'|'daily-wet-derived'|'hourly-max-fallback'");
...
need('Mean/Spread bleibt Schätzung',weather,"precipitationProbabilityQuality?:'native-members'|'estimated-spread'");
