...
assert.ok(audit.includes('Keine Doppelgewichtung von RUC-Bewölkung')&&audit.includes('CEILING, VIS, HZEROCL und SNOWLMT werden ab MID v0.9.85.67 zusätzlich nativ 15-minütig')&&audit.includes('CLCT/CLCL/CLCM/CLCH bleiben stündlich'),'RUC-Kurzfristaudit ist unvollständig.');
