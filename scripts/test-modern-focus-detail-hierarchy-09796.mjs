...
assert.ok(contract.includes('Komposit'),'Navigationsvertrag muss Komposit als Primärziel dokumentieren');
...
console.log('Direkter Komposit-Fokus, Current-Beta-Entfernung und Synoptik-Persistenz geprüft.');
