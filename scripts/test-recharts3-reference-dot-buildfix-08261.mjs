...
for(const token of ['function EnsemblePrecipShape','function EnsembleHazardShape','function EnsembleTemperatureWeatherOverlay','layer:\'weather\'|\'hazards\'','plotBottom=height-margin.bottom-xAxisHeight','cellHeight=Math.max(10,plotHeight*.065)','hazardY=plotBottom-plotHeight*.11'])need(token);
