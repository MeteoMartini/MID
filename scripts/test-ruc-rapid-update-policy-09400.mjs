...
need('RUC direct-only capability',worker,"apiIds:[],label:'DWD ICON-D2-RUC'");
need('RUC direct-only marker',worker,'directOnly:true');
...
need('Radar HRRR Rapid 15min',worker,"apiIds:['ncep_hrrr_conus_15min','ncep_hrrr_conus']");
need('Radar HRRR 15min Metadata',worker,"metaIds:['ncep_hrrr_conus_15min','ncep_hrrr_conus']");
