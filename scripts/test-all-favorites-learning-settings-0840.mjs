...
need('Aufgeräumte Navigation',app,["['view','Ansicht & Einheiten'","['twin','Lokaler Wetterzwilling'","['sync','Daten & Synchronisation'","['system','System & Updates'","section==='twin'&&<WeatherTwinSettingsPanel advancedMode={layoutMode==='advanced'}/>","section==='sync'&&<div className=\"settings-section-stack\"><ICloudBackupSettings advancedMode={layoutMode==='advanced'}/><DeviceSyncSettings advancedMode={layoutMode==='advanced'}/>"]);
