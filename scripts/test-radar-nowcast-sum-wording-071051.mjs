...
assert.match(app,/forecastAmount=timelineSegments\.filter\(segment=>segment\.rate>0&&!segment\.nearby&&segment\.end>now\)\.reduce/,'die +2-h-Niederschlagssumme muss nur aus zukünftigen direkten Standortsegmenten gebildet werden');
