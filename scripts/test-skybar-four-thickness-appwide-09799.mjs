...
assert.ok(skybar.includes('const precipBandLevel=(amount:number):SkyBarThicknessIndex|null=>{')&&skybar.includes('if(amount<0.5)return 0;')&&skybar.includes('if(amount<2.5)return 1;')&&skybar.includes('if(amount<10)return 2;')&&skybar.includes('return 3;'),'Niederschlag muss vier Intensitätsstufen besitzen.');
