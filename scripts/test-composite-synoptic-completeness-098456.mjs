...
assert.ok(radar.includes('name="mid-synoptic-fronts"')&&radar.includes('<MemoCompositeFronts')&&radar.includes('<MemoRegionalFrontalZones'),'Lokale typisierte Fronten und großräumige θe-Frontalzonen müssen als eigener sichtbarer Kartenlayer gerendert werden.');
