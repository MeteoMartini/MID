...
assert.ok(radar.includes("useEffect(()=>{if(!panelVisible)return;const controller=new AbortController();loadModelContours(lat,lon,controller.signal,true)"),'Das Grid muss für bestätigte Modelltermine auch ohne eine aktivierte Live-Überlagerung geladen werden, damit Isohypsen, H/T-Zentren und Frontalzonen am Modelltermin sichtbar sind.');
