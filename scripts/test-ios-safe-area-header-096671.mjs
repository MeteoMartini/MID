...
assert.equal(status.nextMilestone,versionAtLeast(pkg.version,'0.9.68.2')?'lifecycle-offline-resume-without-local-data-loss':versionAtLeast(pkg.version,'0.9.68.1')?'native-share-import-export-with-browser-fallback':versionAtLeast(pkg.version,'0.9.68.0')?'native-external-navigation-with-deep-link-return':'native-location-adapter-with-browser-fallback');
