...
assert.match(radar,/targetMs>=observedMs-2\*60000&&targetMs<=observedMs\+90\*60000/,'K3D objects must remain limited to the supported radar/nowcast time window without leaking current cells into past frames');
