...
if(failures.length){console.error('MID v0.9.33.2 Langfristprüfung fehlgeschlagen:\n- '+failures.join('\n- '));process.exit(1)}
console.log('MID v0.9.33.2: Langfrist-Sektion, lokale ECMWF-SEAS5-Anomalien und C3S-Großmodellvergleich geprüft.');
