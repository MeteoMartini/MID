...
if(failures.length){console.error('MID Langfristprüfung fehlgeschlagen:\n- '+failures.join('\n- '));process.exit(1)}
console.log(`MID ${pv}: Langfrist-Sektion, lokale ECMWF-SEAS5-Anomalien und C3S-Großmodellvergleich geprüft.`);
