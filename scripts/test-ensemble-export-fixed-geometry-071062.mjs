...
const failures=[];
for(const token of ['const ENSEMBLE_RAIN_EXPORT_CHART_WIDTH=992','const ENSEMBLE_TEMP_EXPORT_CHART_WIDTH=992','const ENSEMBLE_WIND_EXPORT_CHART_WIDTH=992','height:exporting?300:compact?276:292'])if(!panel.includes(token))failures.push(`Export-Geometrie fehlt: ${token}`);
