...
if(!app.includes("section==='sync'&&<div className=\"settings-section-stack\"><DeviceSyncSettings advancedMode={layoutMode==='advanced'}/>"))failures.push('Gerätesynchronisation besitzt keinen eigenen Einstellungsbereich.');
