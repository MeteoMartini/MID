...
requireTokens('Einzelne Zugspur',radar,[
 'motionAvailable=showRadar&&Number.isFinite(motionDirection)&&Number.isFinite(motionSpeed)&&motionSpeed>=2','showMotion=showMotionOverlay&&motionAvailable','showMotionField=showMotion','function PrecipitationMotionTrack','motionTrackGraphicIcon','const upstreamBearing=(resolved.direction+180)%360','<MemoPrecipitationMotionTrack site={[lat,lon]}'
]);
...
requireTokens('Objekt-Styling',styles,['.konrad-track','.mid-konrad-marker{','.mid-nowcastmix-marker{','.mid-motion-track-graphic']);
