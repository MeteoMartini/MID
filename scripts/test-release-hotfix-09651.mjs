...
const parts=String(pkg.version).split('.').map(Number);assert.ok(parts[0]>0||parts[1]>9||parts[2]>65||parts[2]===65&&(parts[3]??0)>=1,`Release ${pkg.version} liegt vor dem Hotfix 0.9.65.1.`);
...
console.log(`MID ${pkg.version}: v0.9.65.1-Hotfixvertrag für Worker-Testexports und kompakte Info-Controls bleibt erhalten.`);
