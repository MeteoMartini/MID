...
for(const obsolete of ['Orientierung ohne Modelljargon','nimmt im weiteren Verlauf merklich ab','nimmt im weiteren Verlauf deutlich ab','Gemeinsam konsistente Zeiträume','Bewertung verschlechtert sich'])if(panel.includes(obsolete))failures.push(`Veraltetes Wording vorhanden: ${obsolete}`);
