...
requireTokens('Radar-Zugrichtung UI',radar,['function PrecipitationMotionTrack','motionTrackArrowheadIcon','(direction+180)%360','Zugrichtung nach {Math.round(motionDirection)}°','motionMethod=String(analysis?.motionSource','motionDirectionDeg','motionSpeedKmh']);
