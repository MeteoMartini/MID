...
requireTokens('Radar-Zugrichtung UI',radar,['function PrecipitationMotionArrows','Zugrichtung nach {Math.round(motionDirection)}°','motionMethod=String(analysis?.motionSource','motionDirectionDeg','motionSpeedKmh']);
