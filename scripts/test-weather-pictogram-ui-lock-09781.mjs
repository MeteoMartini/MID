...
assert.ok(pictogram.includes("if(['drizzle','freezing-drizzle','rain','freezing-rain','sleet','snow','snow-grains','ice-crystals','ice-pellets','graupel','hail','wintry-after-thunder'].includes(kind))return'generic'"), 'Stratiformer Niederschlag muss die einheitliche Niederschlagswolke des Referenzdesigns verwenden.');
