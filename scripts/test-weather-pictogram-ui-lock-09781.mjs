...
assert.ok(pictogram.includes("showCelestial=['mostly-clear','partly-cloudy','showers','sleet-showers','snow-showers','graupel-showers','hail-showers'].includes(kind)&&!afterThunderShower,showVeiledCelestial=false,showFogCelestial=false"),'Stratiforme Wetterzustände dürfen nicht durch einen identischen künstlichen Sonnen-/Mondrest verwischt werden.');
...
assert.ok(pictogram.includes("if(['drizzle','freezing-drizzle','rain','freezing-rain','sleet','snow','snow-grains','snow-stars','ice-crystals','ice-pellets','graupel','hail','wintry-after-thunder'].includes(kind))return'generic'"), 'Stratiformer Niederschlag muss die einheitliche Niederschlagswolke des Referenzdesigns verwenden.');
