...
for(const token of ['#ffc229','#aeb3b9','Sonnenschein/Klarheit · Stufe','Gesamtbewölkung · Stufe'])assert.ok(skybar.includes(token),`Skybar-Vertrag fehlt: ${token}`);
assert.ok(cockpit.includes('data-mid-skybar="profile"'),'Die Sonne-/Wolken-Leiste im 24-h-Profil muss explizit markiert sein.');
...
console.log(`MID v${pkg.version}: transparente Wertepillen und gemeinsame Tagesansicht-Sonne/Wolken-Leiste im 24-h-Profil geschützt.`);
