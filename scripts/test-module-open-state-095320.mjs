...
assert.match(app,/const MODULE_OPEN_CONTRACT_KEY='mid:module-open-contract:v6'/,'Einheitlicher Modul-Offenvertrag fehlt');
...
assert.match(app,/const MODULES_DEFAULT_CLOSED=\['ventilation','mountain','water','composite','ensemble','long-range','climate','forecast-verification','travel-planner','event-planner','flight-meteorology','weather-maps','widget'\]/,'Große Standardmodule müssen bei der Vertragsmigration konsistent geschlossen initialisiert werden');
