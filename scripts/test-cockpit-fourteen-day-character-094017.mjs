...
for(const token of [
 'function ensembleSeries(ensemble:EnsembleDay[],days:Day[],climate:ClimateDay[],hours:Hour[]=[],assessmentTime=Date.now()){',
 ...
 'ensembleSeries(ensemble,days,climate,hours,assessmentTime)',
