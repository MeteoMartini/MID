...
for(const token of ['plotBottom=height-margin.bottom-xAxisHeight','cellY=plotBottom-cellHeight','hazardY=Math.max(plotTop+8,cellY-10)','cellX=centerX-dayWidth*.46','cellWidth=dayWidth*.92'])need('Hochformat-Plotbindung',panel,token);
