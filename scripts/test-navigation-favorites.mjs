...
if(!app.includes('return favorites.length>=20?[...favorites.slice(0,19),added]:[...favorites,added]'))failures.push('Neu angelegte Favoriten werden nicht am Ende einsortiert.');
