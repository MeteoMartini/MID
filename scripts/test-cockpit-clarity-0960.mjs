...
for(const token of ['regularShortTermPoints','cockpit-now90','cockpit-inline-toggle','WeatherPictogram code={parts.displayCode}','cockpit-day-regime','regimeLabel(regime)','formatDecimalFixed(day.precipitation,1)} mm','cockpit-fourteen-row'])assert.ok(cockpit.includes(token),`Klarheitsbaustein fehlt: ${token}`);
