...
const checks=[
  ...
  ['header receives dynamic brand logo path',appSource.includes('brandLogoPath:string')&&appSource.includes('srcSet={brandLogoPath}')&&appSource.includes('src={horizontalBrandLogoPath}')],
