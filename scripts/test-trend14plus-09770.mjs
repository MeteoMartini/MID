...
const checks=[
  ...
  ['era5-land climatology endpoint',source.includes("const CLIMATE_ENDPOINT='https://archive-api.open-meteo.com/v1/archive'")],
  ['era5-land climatology period',source.includes("start_date:'1991-01-01'")&&source.includes("end_date:'2020-12-31'")&&source.includes("models:'era5_land'" )],
  ['climate covers every displayed raw metric',source.includes('const CLIMATE_DAILY_VARIABLES=[...DAILY_VARIABLES]')],
  ['climate cache is separate and long-lived',source.includes("CLIMATE_CACHE_PREFIX='mid:subseasonal-climatology:1991-2020:v2'")&&source.includes('CLIMATE_MAX_AGE_MS=180*86400000')],
