...
if(!app.includes("currentFavorite=useMemo(()=>matchingStoredFavorite(favorites,loc)")||!app.includes("displayLocationName=currentFavorite?favoriteLabel(currentFavorite):loc?.name??'Standort'")){
