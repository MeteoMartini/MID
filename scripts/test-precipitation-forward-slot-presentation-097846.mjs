...
assert.ok(app.includes('precipitationPresentationHours,precipitationPresentationMinutes15')&&app.includes("from './precipitationIntervals';"),'Klassische 7d-/Widgetpfade müssen beide Präsentationshelfer importieren.');
