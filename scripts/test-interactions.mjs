...
for(const token of ['allowEscapeViewBox={{x:false,y:true}}',"maxWidth:'calc(100vw - 24px)'"])if(!ensemble.includes(token))failures.push(`Trend-Tooltip ist horizontal nicht begrenzt: ${token}`);
