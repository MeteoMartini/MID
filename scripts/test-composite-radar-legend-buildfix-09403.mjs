...
assert(source.includes("showRadar&&!highResolution&&activeSource==='dwd'&&dwdVisualBlend.map"),'1-km DWD radar must keep its timed frame blend plus retained-frame crossfade.');
