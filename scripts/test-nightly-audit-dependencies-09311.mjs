...
if(browserslist&&!atLeast(browserslist.version,'4.28.7'))failures.push(`browserslist ist ${browserslist.version}; falls installiert, ist >=4.28.7 wegen GHSA-73wf-gq98-2v4g/GHSA-c83g-rgw3-j3cx erforderlich.`);
...
console.log(`Nächtliche Audit-Abhängigkeiten geprüft: nanoid ${nano.version}, protocol-buffers-schema ${proto.version}, postcss ${post.version}, browserslist ${browserslist?.version??'nicht installiert (nicht betroffen)'}.`);
