...
const nano=lock.packages?.['node_modules/nanoid'],proto=lock.packages?.['node_modules/protocol-buffers-schema'],post=lock.packages?.['node_modules/postcss'];
...
console.log(`Nächtliche Audit-Abhängigkeiten geprüft: nanoid ${nano.version}, protocol-buffers-schema ${proto.version}, postcss ${post.version}.`);
