...
for(const token of ['signal.level>=2','Best-Match-Hazards','ensemble-hazard-tooltip'])if(!ensemble.includes(token))failures.push(`Ensemble-Hazard-Tooltip fehlt: ${token}`);
