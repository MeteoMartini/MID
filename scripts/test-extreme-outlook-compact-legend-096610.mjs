...
for(const token of ["1:'Gefahr'","2:'markant'","3:'Unwetter'","4:'extrem'",'unter 60 %','id="extreme-outlook-context"','opacity={.36}','zIndex={18}','id="extreme-outlook-labels"','zIndex={20}'])assert.ok(panel.includes(token),`Kompakte Legende oder Vordergrundkontext unvollständig: ${token}`);
