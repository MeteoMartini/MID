...
assert.ok(versionAtLeast(pkg.version,'0.9.66.10'));
...
assert.ok(!sourceUsesHttpsHost(panel,'basemaps.cartocdn.com'),'Die kompakte Extremkarte darf keine CARTO-API-Key-Wasserzeichen laden.');
