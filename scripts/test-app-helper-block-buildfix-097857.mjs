...
if(!app.includes('<ForecastConditionPills label={compactSevenDayConditionLabel(d,allDayHoursForDate)} regime={regime}/>')){console.error('Compact 7-day forecast pill contract missing');process.exit(1)}
