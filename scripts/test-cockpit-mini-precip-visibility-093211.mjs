...
if(pv!=='0.9.32.11') failures.push(`Erwartete Version 0.9.32.11, erhalten ${pv}`);
if(failures.length){
 console.error(`MID v0.9.32.11 Mini-Niederschlags- und Zeitbarkeits-Regressionsprüfung fehlgeschlagen:\n- ${failures.join('\n- ')}`);
 process.exit(1);
}
console.log('MID v0.9.32.11: Mini-Niederschlagskombination und sichtbare Zeitangaben im 24-h-Wetterprofil geprüft.');
