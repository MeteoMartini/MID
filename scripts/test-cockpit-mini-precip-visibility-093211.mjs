...
if(failures.length){
 console.error(`MID Mini-Niederschlags- und Zeitbarkeits-Regressionsprüfung fehlgeschlagen:\n- ${failures.join('\n- ')}`);
 process.exit(1);
}
console.log(`MID ${pv}: Mini-Niederschlagskombination und sichtbare Zeitangaben im 24-h-Wetterprofil geprüft.`);
