...
assert.ok(!cockpit.includes('cockpit-fourteen-detail-skybar')&&!cockpit.includes('Skybar · 24 Einzelstunden'),'14-Tage-Detail darf ab v0.9.85.96 keine zweite Skybar mehr duplizieren.');
...
console.log(`${pkg.version}: Windpfeil, +12-h-Layout, stündliches 24-h-Profil, kompakte 14d-Einzelskybar sowie 7-/14-Tage-Responsive-Fixes geschützt.`);
