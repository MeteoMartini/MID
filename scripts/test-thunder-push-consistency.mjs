...
const directBody=worker.thunderPushBody(directState,{id:'tracked-location',name:'Aktueller Standort · Rheidt'});
...
if(!directBody.includes('unmittelbar am Standort'))failures.push(`Unmittelbarer Pushtext fehlt: ${directBody}`);
