...
assert.ok(app.includes('<MidWeatherThread points={currentThreadTemperatures} minimumSpan={4} label={\`Temperaturtrend von jetzt bis plus \${currentThreadHorizon} Stunden\`}/>'),'Skalentreuer 12-h-Wetterfaden fehlt in Aktuell.');
