...
const worker=await concat(['worker-src/00-core-observations.js','worker-src/05-knmi-eps-cache.js','worker-src/08-konrad-track-history.js','worker-src/10-radar-nowcast.js','worker-src/20-composite-models.js','worker-src/25-dach-extreme-outlook.js','worker-src/30-push-events.js','worker-src/40-aviation-router.js']);
