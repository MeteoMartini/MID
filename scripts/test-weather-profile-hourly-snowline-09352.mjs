...
for(const token of ['function snowLineNumber(value:unknown)','let mean=snowLineNumber(snow[index]),spread=snowLineNumber(snowSpread[index])','const freeze=snowLineNumber(freezing[index])'])need('Schneefallgrenze',mountain,token);
