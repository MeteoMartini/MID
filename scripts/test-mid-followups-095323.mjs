...
assert.match(eventEngine,/precipitationProbabilityRelevant=eventProbability\?\.probability\?\?fallbackProbability/,'Event-PoP muss Ensemble priorisieren und darf nur bei vollständiger Stundenabdeckung auf den markierten Zeitraum-Fallback zurückfallen.');
