...
assert.match(sevenDay,/sunShare=Number\.isFinite\(sunHours\)\?Math\.max\(0,Math\.min\(1,sunHours\/Math\.max\(1,sevenDayDaylightHours\(day\)\)\)\):0/,'Sonnenscheindauer muss nullsicher relativ zur Tageslänge bewertet werden');
