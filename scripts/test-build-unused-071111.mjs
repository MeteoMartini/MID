...
if(!weather.includes('function scenarioDivergenceDate(')||!weather.includes('for(let index=1;index<dates.length;index++)'))failures.push('Bereinigte Divergenzsuche fehlt.');
