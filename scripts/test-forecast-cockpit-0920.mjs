...
for(const token of ['cockpit-fourteen-grid','cockpit-fourteen-compact-meta','formatDecimalFixed(item.bestPrecipitation,1)','climateMean','assessEnsembleDay','Konsistenz'])need('14-Tage',cockpit,token);
