...
for(const token of ["const FORECAST_COCKPIT_MODULES:DashboardModuleId[]=['short-term','forecast','ensemble']","const forecastCockpitEnabled=designMode==='mid-next'","forecastCockpitEnabled&&FORECAST_COCKPIT_MODULES.includes(id)","if(id!==forecastCockpitAnchor)return null"])need('Keine Doppelmodule',app,token);
...
console.log('Klassische Standardansicht sowie Design-2.0.1-Register- und Ribbon-Cockpit geprüft.');
