...
for(const token of ['cockpit-now90',"points=useMemo(()=>selectShortTermPoints(adjusted,'1h')",'Darstellung durchgängig einstündig.','regularShortTermPoints','SvgWindDirectionArrow','Böen bis'])need('Kurzfrist',cockpit,token);
