...
for(const token of ["needs.deploy_pages_1.outputs.deployed == 'true'","needs.deploy_pages_2.outputs.deployed == 'true'","needs.deploy_pages_3.outputs.deployed == 'true'",'continue-on-error: true','finalize_release:','HEAD:refs/heads/mid-stable'])need('Installer-Finalisierung',install,token);
