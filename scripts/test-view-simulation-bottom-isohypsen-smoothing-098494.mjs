...
assert.ok(radar.includes("hasRenderableIsoheights=Boolean(nativeIsoheightReady||(vectorIsoheightFrame&&hasGridIsoheights))")&&radar.includes("synopticReady=modelLines==='off'?true:modelLines==='isobars'?(hasRenderableSynopticFrame&&hasRenderableIsobars):modelLines==='isoheights'?Boolean(hasRenderableSynopticFrame&&hasRenderableIsoheights):Boolean((hasRenderableSynopticFrame&&hasRenderableIsobars)&&hasRenderableIsoheights)"), 'Die Bereitschaftslogik für Synoptik/Isohypsen muss den nativen DWD-WMS-Linienmodus und den geglätteten Vektor-Fallback getrennt nach Linienmodus akzeptieren.');
