...
assert.equal(pkg.dependencies?.['lucide-react'],'^1.30.0');
assert.equal(lock.packages?.['node_modules/lucide-react']?.version,'1.30.0');
...
assert.ok(policy.includes('Lucide React: 1.30.0'));
...
console.log('Freigegebene Dependency-/Action-Upgrades geprüft: checkout 7.0.1, setup-node 7.0.0, Lucide React 1.30.0 und Recharts 3.10.1; React 19, plugin-react 6/Vite 8 und TypeScript 7 bleiben zurückgestellt.');
