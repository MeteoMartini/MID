...
console.log('Komposit-Zeitpfeil-Zoomskalierung geprüft: Geo-Pfad und runde dynamische Zeitschritte aus Geschwindigkeit, sichtbarer Kartenstrecke, Zoom und Displaydichte.');
