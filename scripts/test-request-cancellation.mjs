...
if(!app.includes("if(!c.signal.aborted&&requestId===searchRequestRef.current){setResults(x);setSearching(false);setSearchError('');setOpen(true)}"))failures.push('Abgebrochene oder verspätete Suchanfragen können weiterhin neue Ergebnisse überschreiben.');
