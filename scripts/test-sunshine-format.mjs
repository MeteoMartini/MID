...
if(!ensemble.includes('<em>P10–P90</em><strong>{formatSunshineHours(row.sunshineLowHours)} bis {formatSunshineHours(row.sunshineHighHours)} h</strong>'))failures.push('Ensemble-Tooltip: P10–P90-Bezeichnung der Sonnenscheindauer fehlt');
