...
assert.equal(pkg.version,'0.9.67.2');
...
assert.ok(serviceWorker.includes("const CACHE='mid-shell-v0.9.67.2'"));
...
assert.ok(workerSource.includes("const WORKER_VERSION='0.9.67.2'"));
assert.ok(changelog.startsWith('## 0.9.67.2'));
