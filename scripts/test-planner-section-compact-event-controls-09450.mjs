...
assert.ok(app.includes('<ModernPlannerHub eventEnabled={dashboardModuleSettings.enabled[\'event-planner\']}'),'Optionaler Bottom-Tab-Modus muss den bestehenden Planer um den Planen-Hub ergänzen.');
