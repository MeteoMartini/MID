...
for(const token of ['function EnsembleTemperatureCanvas','function EnsembleTemperatureWeatherOverlay','plotWidth/Math.max(1,data.length)','layer="weather"','layer="hazards"'])need('Wetterband',panel,token);
