...
for(const token of ['function EnsembleTemperatureCanvas','function EnsembleTemperatureWeatherOverlay','dayCount=Math.max(1,data.length)','cellSlotWidth=plotWidth/dayCount','cellRight=slotIndex===dayCount-1?plotRight:plotLeft+(slotIndex+1)*cellSlotWidth','layer="weather"','layer="hazards"'])need('Wetterband',panel,token);
