...
for(const token of ['function EnsembleTemperatureCanvas','function EnsembleTemperatureWeatherOverlay','dayCount=Math.max(1,data.length)','cellRight=plotLeft+((slotIndex+1)/dayCount)*plotWidth','layer="weather"','layer="hazards"'])need('Wetterband',panel,token);
