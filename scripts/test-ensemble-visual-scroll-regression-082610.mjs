...
for(const token of ['function EnsembleTemperatureCanvas','function EnsembleTemperatureWeatherOverlay','dayCount=Math.max(1,data.length)','cellSlotWidth=plotWidth/dayCount','layer="weather"','layer="hazards"'])need('Wetterband',panel,token);
