...
console.log('Schwebende Bottom-Bar: fünf eindeutige Ziele, Warnstatus im Ortskopf, optional fixiert, sichere iPhone-Lage und sanftes Autohide mit sichtbarem Griff geprüft.');
