...
try{
 ...
 const authUrl=new URL(start.authorizeUrl),state=authUrl.searchParams.get('state');if(authUrl.searchParams.get('scope')!=='read_station'||!state)throw new Error('OAuth-URL ist unvollständig.');
