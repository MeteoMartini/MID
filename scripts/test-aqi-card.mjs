...
for(const token of ['EEA_AIR_QUALITY_STATIONS','nearestEeaAirQualityStation','AQStationName','AirQualityStationEoICode',"mode==='air-quality-station'"])need(worker,token,'EEA-Messstationsmetadaten fehlen');
