...
const failures=[];
for(const token of ['function professionalEnsembleLayout(','xAxisHeight:compact?70:66','leftAxisWidth:compact?42:54','rightAxisWidth:compact?34:44','height:exporting?300:compact?276:292','xAxisHeight={layout.xAxisHeight}'])if(!panel.includes(token))failures.push(`Gemeinsame Temperaturachse fehlt: ${token}`);
