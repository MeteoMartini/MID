...
if(failures.length){console.error('MID Poor-Man’s-Ensemble/Schneefallgrenze fehlgeschlagen:\n- '+failures.join('\n- '));process.exit(1)}console.log('MID: unabhängiges ECMWF+NOAA-Langfrist-Poor-Man’s-Ensemble sowie Schneegrenzen-Multi-Modell 1/3/7/14 Tage geprüft.');
