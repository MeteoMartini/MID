...
- Die vier Niederschlagsdicken verwenden die zeitnormalisierte Intensität. Für Regen werden die DWD-Klassen **leicht bis 0,5 mm/h**, **mäßig über 0,5 bis 4 mm/h** und **stark über 4 mm/h** verwendet. Für die vierte MID-Dickenstufe wird die DWD-Klasse „stark“ rein darstellerisch bei **15 mm/h** weiter unterteilt: `>4 bis <15 mm/h` = Stufe 3, `≥15 mm/h` = Stufe 4. Diese vierte Stufe ist **keine zusätzliche DWD-Intensitätsklasse**. Werte unter `0,05 mm/h` gelten für die Skybar nur als Spur und erzeugen keinen Niederschlagsstreifen.
