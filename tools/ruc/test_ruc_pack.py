...
write_meta(out,run='2026-08-28T18:00',times=['2026-08-28T18:00','2026-08-28T18:15','2026-08-28T18:30'],point_count=2,specs=specs,grid={'latMin':43,'lonMin':-4,'dx':.02,'dy':.02,'nx':2,'ny':1},deterministic_key='runs/r/det.bin',eps_key='runs/r/eps.bin',eps_summary_key='runs/r/eps-summary.bin',lookup_key='runs/r/lookup.bin',member_count=2,deterministic_times=['2026-08-28T18:00','2026-08-28T18:15','2026-08-28T18:30'],eps_summary_times=['2026-08-28T18:00','2026-08-28T19:00'],eps_times=['2026-08-28T18:00','2026-08-28T19:00'],objects={'deterministic.bin':{'bytes':16,'sha256':'a'*64},'eps-summary.bin':{'bytes':48,'sha256':'b'*64},'eps-members.bin':{'bytes':16,'sha256':'c'*64},'lookup.bin':{'bytes':8,'sha256':'d'*64}})
...
assert meta['times']==['2026-08-28T18:00','2026-08-28T18:15','2026-08-28T18:30'] and meta['deterministic']['times']==meta['times']
assert meta['epsSummary']['times']==['2026-08-28T18:00','2026-08-28T19:00'] and meta['eps']['times']==['2026-08-28T18:00','2026-08-28T19:00']
