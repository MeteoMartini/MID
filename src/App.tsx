...
import {AlertTriangle,BadgeCheck,Cloud,Download,Droplets,Gauge,LocateFixed,Moon,Navigation,Pause,Play,RefreshCw,Search,Settings2,SkipBack,SkipForward,Sun,ThermometerSun,Umbrella,Wind,X} from 'lucide-react';
