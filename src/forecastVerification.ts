...
export function buildForecastVerificationReport(locationKey:string,days:Day[]=[],ensemble:EnsembleDay[]=[],location?:Location,hours:Hour[]=[]):ForecastVerificationReport{
