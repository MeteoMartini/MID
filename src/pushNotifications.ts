...
async function readyRegistration(){const registration=await navigator.serviceWorker.ready;if(!registration.active)throw new Error('Der Benachrichtigungsdienst ist noch nicht aktiv. App bitte neu öffnen.');return registration}
