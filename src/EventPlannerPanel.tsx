    ...
    <details className="event-center-card-disclosure">
     <summary>
      <span className="event-center-card-overview">
       ...
       <span className="event-center-card-quick-weather"><span className="event-center-card-weather-visual"><WeatherPictogram code={recordPlan?.summary.weatherCode??0} intensity={recordPlan?.summary.weatherIntensity} day={recordPlan?.summary.isDay!==false} title={recordPlan?.summary.weatherLabel||label(recordPlan?.summary.weatherCode??0)}/><EventFeasibilityDot plan={recordPlan}/></span><span>{eventMetricLine(recordPlan,unit)}</span></span>
      </span>
     ...
     <div className="event-center-card-details">
      <div className="event-center-card-weather"><WeatherPictogram code={recordPlan?.summary.weatherCode??0} intensity={recordPlan?.summary.weatherIntensity} day={recordPlan?.summary.isDay!==false} title={recordPlan?.summary.weatherLabel||label(recordPlan?.summary.weatherCode??0)}/><div><b>{recordPlan?.advice.headline||'Noch keine Analyse'}</b><span>{recordPlan?.advice.summary||destinationLabel(record.location)}</span></div></div>
