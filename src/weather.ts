...
export type OfficialAlert={id:string;headline:string;description:string;instruction?:string;level:OfficialAlertLevel;severity?:string;event?:string;source:string;area?:string;areaCodes?:string[];effective?:string;onset?:string;expires?:string;updatedAt?:string;url?:string};
