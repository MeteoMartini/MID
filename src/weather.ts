...
export async function airQualityStation(lat:number,lon:number,signal?:AbortSignal){return fetchWorkerJson<AirQualityStationMeta>('air-quality-station',{lat,lon},{purpose:'general',signal,timeoutMs:12000,cache:'default'})}
