...
import {boundedSunshineSeconds,canonicalSunshineDaySeconds,canonicalSunshineHourSeconds,daylightSecondsFromLocalTimes,type SunshineDurationDiagnostic} from './sunshineDuration';
...
function weatherSunshineHourSeconds(w:Weather,time:string,index:number){return canonicalSunshineHourSeconds(w.hourly.sunshine_duration?.[index],minutelySunshineValuesForHour(w,time))}
