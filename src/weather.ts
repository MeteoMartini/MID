...
export type KonradTrackPoint={time?:string;minutes:number;latitude:number;longitude:number;distanceKm?:number;effectiveDistanceKm?:number;uncertaintyKm?:number;uncertaintyMinorKm?:number};
