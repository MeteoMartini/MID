...
export default function TravelPlannerPanel({initialLocation,advancedMode}:Props){
 ...
 return <section className="travel-planner">
  ...
  <div className="travel-method-note"><AlertTriangle size={15}/><span>Das Ergebnis ist eine klimatologische Erwartung aus vergangenen Jahren und keine Wettervorhersage für den konkreten Reisetermin. Pro etwa 10-km-Klimaraster erfolgt höchstens ein direkter Basisabruf; das Ergebnis bleibt drei Jahre lokal gespeichert. Die Schneehöhe ist ein optionaler Zusatzabruf. Der MID-Worker wird dafür nicht verwendet.</span></div>
