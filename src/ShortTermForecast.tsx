...
function DirectionArrow({direction}:{direction:number}){const to=Number.isFinite(direction)?((direction+180)%360+360)%360:0;return <Navigation size={13} style={{transform:`rotate(${to}deg)`}} aria-hidden="true"/>}
