...
function BrowserPwaInstallButton({suppressTransientHint=false}:{suppressTransientHint?:boolean}){
 ...
 return <>
  ...
  {hintReady&&!hintDismissed&&!installed&&!open&&!suppressTransientHint&&<aside className="pwa-install-hint" role="status" aria-label="Hinweis zur Installation als App">
...
export function PwaInstallButton({suppressTransientHint=false}:{suppressTransientHint?:boolean}={}){return isMidNativeRuntime()?null:<BrowserPwaInstallButton suppressTransientHint={suppressTransientHint}/>} 
